...
public class Request {
	...
	public void setBusinessLogicConfigurationStrings(List<String> businessLogicConfigurationStrings) {
	...
	public Request(String requestString) {
		...
		id = requestParams[0];
		String[] handlersParams = requestParams[1].split(Delimiters.FIELD_DELIMITER);
		...
		handlerConfiguration = new HandlerConfiguration(Boolean.parseBoolean(handlersParams[0]), businessLogic, businessLogicConfigurationStrings);
